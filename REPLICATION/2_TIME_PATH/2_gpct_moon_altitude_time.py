...
try:
    df = pd.read_csv("gpct_time.csv", usecols=["external_timestamp"])
    ...
    print(f"Error reading 'gpct_time.csv': {e}")
    sys.exit(1)
print(f"Date range found in gpct_time.csv: {start_date} to {end_date}")

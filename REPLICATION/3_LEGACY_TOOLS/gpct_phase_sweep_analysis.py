...
# Load merged dataset
merged_df = pd.read_csv("lunar_aligned.csv", parse_dates=["timestamp"])
...
offsets = np.arange(-12, 12.84, 1.035)  # inclusive of +12
...
plt.title("Phase Sweep: Collapse Correlation vs Gravitational Offset (Lunar day, Timestamp-based)")
